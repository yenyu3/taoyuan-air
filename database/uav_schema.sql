...
-- 建立日期: 2026-05-26
-- 儀器: Aeromount V2A009 + POM1781
-- 資料範圍: 2026-03-30，共 6 次飛行任務
-- 量測參數: 23 個（氣象 14 種、氣膠 3 種、氣體 6 種）
-- 資料流程: txt → 直接匯入 DB
...
-- 空間索引
CREATE INDEX IF NOT EXISTS idx_uav_location
...
VALUES
    -- altitude
    ('agl',    '離地高度',   'AGL Height',                  'm',       'altitude'),
    ('asl',    '海拔高度',   'ASL Height',                  'm',       'altitude'),
    -- meteorology
    ...
    ('mixR',   '混合比',     'Mixing Ratio',                'g/kg',    'meteorology'),
    ('Tv',     '虛溫',       'Virtual Temperature',         'K',       'meteorology'),
    ('thetav', '虛位溫',     'Virtual Potential Temp.',     'K',       'meteorology'),
    -- aerosol
    ...
    ('TVOC',   '總揮發性有機物', 'Total VOC',               'ppm',     'gas')
...
COMMENT ON TABLE uav_parameters IS 'UAV 量測參數定義（23 個：氣象 14、氣膠 3、氣體 6）';
COMMENT ON TABLE uav_data       IS 'UAV 量測資料（長表，按 flight_id LIST 分區）';
