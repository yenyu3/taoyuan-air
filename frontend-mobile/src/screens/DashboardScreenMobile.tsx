          ...
          <View style={styles.insightCard}>
            <View style={styles.insightIconContainer}>
              <View style={styles.insightIconBg}>
                <Feather name="trending-up" size={20} color="#6a8d73" />
              </View>
            </View>
          ...
          <View style={styles.card}>
            ...
            <View style={styles.cardHeaderRow}>
              <View style={styles.cardTitleGroup}>
                <Feather name="wind" size={15} color="#6a8d73" />
            ...
            <View style={{ marginBottom: 4 }}>
              <View style={[styles.cardTitleGroup, { marginTop: 20 }]}>
                <Feather name="alert-circle" size={15} color="#6a8d73" />
          ...
          <View style={styles.card}>
            ...
            <View style={styles.cardHeaderRow}>
              ...
              <View style={styles.districtBadge}>
                <Feather name="map-pin" size={10} color="#8fa96f" />
                ...
                >
                  ...
                  <View style={styles.forecastPopRow}>
                    <Feather
                      name="cloud-rain"
                      size={10}
                      color={Number(day.precipProb) >= 50 ? "#7fae8a" : "#bbb"}
                    />
                    <Text
                      style={[
                        styles.forecastPopText,
                        Number(day.precipProb) >= 50 && { color: "#7fae8a" },
                      ]}
                    >
                      {day.precipProb}%
                    </Text>
...
const styles = StyleSheet.create({
  ...
  loadingContainer:       { flex: 1, justifyContent: "center", alignItems: "center", backgroundColor: "#f4f2e9" },
  loadingText:            { marginTop: 16, fontSize: 16, color: "#6a8d73" },
  scrollView:             { flex: 1 },
  ...
  insightIconBg:          { width: 40, height: 40, borderRadius: 12, backgroundColor: "rgba(106, 141, 115, 0.15)", justifyContent: "center", alignItems: "center" },
  insightContent:         { flex: 1 },
  insightTitle:           { fontSize: 14, fontWeight: "bold", color: "#666", letterSpacing: 1, marginBottom: 8 },
  insightText:            { fontSize: 15, color: "#3D3A33", lineHeight: 22 },
  highlightText:          { color: "#6a8d73", fontWeight: "bold" },
  ...
  adviceText:             { fontSize: 13, color: "#5d6f49", lineHeight: 20 },
  ...
  miniBarFill:            { backgroundColor: "#6a8d73", height: "100%", borderRadius: 3 },
  miniPollutRight:        { flexDirection: "row", alignItems: "baseline", gap: 3, width: 52, justifyContent: "flex-end" },
  miniPollutVal:          { color: "#6a8d73", fontSize: 15, fontWeight: "700" },
  ...
  miniPillSub:       { fontSize: 10, color: "#5d6f49", marginBottom: 4 },
  miniPillVal:       { color: "#6a8d73",fontSize: 14, fontWeight: "700" },
  miniPillValRow:    { flexDirection: "row", justifyContent: "center", alignItems: "center" , gap: 8 },
  miniPillUnit:      { fontSize: 9, color: "#aaa" },

  // ── Weather card ──
  districtBadge:          { flexDirection: "row", alignItems: "center", gap: 4, paddingHorizontal: 10, paddingVertical: 4, backgroundColor: "rgba(143, 169, 111, 0.12)", borderRadius: 10, borderWidth: 1, borderColor: "rgba(143, 169, 111, 0.25)" },
  districtBadgeText:      { fontSize: 12, fontWeight: "600", color: "#8fa96f" },
  ...
  weatherIconCircle:      { width: 72, height: 72, borderRadius: 36, backgroundColor: "rgba(106, 141, 115, 0.1)", justifyContent: "center", alignItems: "center" },
  ...
  forecastTempHigh:       { fontSize: 13, fontWeight: "700", color: "#6a8d73" },
  forecastTempLow:        { fontSize: 13, color: "#8fa96f", fontWeight: "600" },
