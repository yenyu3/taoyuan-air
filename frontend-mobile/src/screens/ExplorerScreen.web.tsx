        ...
        <View style={styles.filtersRow}>
          ...
          <View style={styles.topFilterGroup}>
            ...
            >
              ...
              <Ionicons name="chevron-down" size={14} color={showTimeFilter ? "white" : "#6a8d73"} />
            </TouchableOpacity>
            {showTimeFilter && (
          ...
          <View style={styles.topFilterGroup}>
            ...
            >
              ...
              <Ionicons name="chevron-down" size={14} color={showPollutantFilter ? "white" : "#6a8d73"} />
            </TouchableOpacity>
            {showPollutantFilter && (
              <View style={styles.topDropdown}>
          ...
          <View style={styles.topFilterGroup}>
            ...
            >
              ...
              <Ionicons name="chevron-down" size={14} color={showRegionFilter ? "white" : "#6a8d73"} />
            </TouchableOpacity>
            {showRegionFilter && (
              <View style={styles.topDropdown}>
          ...
          <View style={styles.topFilterGroup}>
            ...
            >
              ...
              <Ionicons name="chevron-down" size={14} color={showDataSourceFilter ? "white" : "#6a8d73"} />
            </TouchableOpacity>
                ...
                {dataSourceOptions.map(option => (
                  ...
                  >
                    ...
                    {selectedDataSources.includes(option) && (
                      <Ionicons name="checkmark" size={14} color="#6a8d73" />
                    )}
                  </TouchableOpacity>
                ))}
              </View>
            ...
            {monitoringData.map((item) => (
              <View key={item.id} style={styles.monitoringCard}>
                ...
                <View style={styles.cardHeader}>
                  ...
                  <View style={[styles.statusBadge, { backgroundColor: item.passed ? '#b5c99a' : '#FFD4B3' }]}>
                    <Text style={[styles.statusBadgeText, { color: item.passed ? '#6a8d73' : '#D2691E' }]}>
                      {item.passed ? '通過' : '異常'}
                    </Text>
                  </View>
                </View>
...
const styles = StyleSheet.create({
  ...
  topFilterButton: {
    ...
    paddingVertical: 8,
    backgroundColor: 'rgba(106, 141, 115, 0.07)',
    borderRadius: 20,
    gap: 6,
  },
  topDropdown: {
