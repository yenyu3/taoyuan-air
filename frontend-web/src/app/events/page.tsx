...
const allEventData: EventData[] = [
  ...
  { id: 2, category: '大氣流入',   title: '重度 PM₂.₅ 流入', description: '跨境污染物透過東北風持續流入，影響北部住宅區域，濃度持續上升。',           severity: '高風險',   status: 'AI 識別', trend: '上升中', exposure: '~3.5k 人', duration: '2 小時 15 分鐘', location: '蘆竹區', confidence: '98.4%',    isActive: true,  isResolved: false },
  ...
  { id: 5, category: '區域性事件', title: '桃園市區空品惡化', description: '多個測站同時檢測到 PM₂.₅ 升高，低壓系統造成污染物堆積，影響範圍持續擴大。', severity: '高風險',   status: '固定站',  trend: '持平',   exposure: '~5.8k 人', duration: '3 小時',          location: '桃園區', healthIndex: '不健康',   isActive: true,  isResolved: false },
];
