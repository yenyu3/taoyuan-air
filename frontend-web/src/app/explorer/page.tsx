...
function pollutantColor(pollutant: string, value: number): string {
  if (pollutant === 'PM₂.₅') return value <= 15.4 ? C.primary : value <= 35.4 ? C.amber : C.red;
  if (pollutant === 'O₃')    return value <= 54   ? C.primary : value <= 70   ? C.amber : C.red;
...
const allMonitoringData: StationData[] = [
  { id: 1,  district: '中壢工業區',   station: 'Station TY-09',    time: '14:02', passed: true,  pollutant: 'PM₂.₅', value: 12, unit: 'μg/m³', source: 'MOE',   version: 'v2.1', timeCategory: '近24小時', region: '中壢區', trend: '下降中', aqi: 45,  temperature: 26, humidity: 68 },
  { id: 2,  district: '蘆竹工業區',   station: 'Grid Alpha-4',     time: '13:45', passed: false, pollutant: 'PM₂.₅', value: 48, unit: 'μg/m³', source: '微感測', version: 'v2.0', timeCategory: '近24小時', region: '蘆竹區', trend: '上升中', aqi: 128, temperature: 28, humidity: 72 },
  { id: 3,  district: '觀音海岸',     station: 'Sensor TY-42',     time: '13:20', passed: true,  pollutant: 'PM₂.₅', value: 8,  unit: 'μg/m³', source: '光達',   version: 'v2.1', timeCategory: '近24小時', region: '觀音區', trend: '穩定中', aqi: 30,  temperature: 24, humidity: 78 },
  { id: 4,  district: '大園工業區',   station: 'Station TY-15',    time: '12:30', passed: true,  pollutant: 'O₃',    value: 35, unit: 'ppb',    source: 'MOE',   version: 'v2.1', timeCategory: '近24小時', region: '大園區', trend: '穩定中', aqi: 42,  temperature: 27, humidity: 65 },
  ...
  { id: 7,  district: '觀音工業區',   station: 'Grid Beta-7',      time: '昨日 23:30', passed: false, pollutant: 'PM₂.₅', value: 52, unit: 'μg/m³', source: '微感測', version: 'v2.0', timeCategory: '近3天', region: '觀音區', trend: '上升中', aqi: 140, temperature: 23, humidity: 80 },
  { id: 8,  district: '大園住宅區',   station: 'Station TY-22',    time: '昨日 22:15', passed: true,  pollutant: 'O₃',    value: 28, unit: 'ppb',    source: 'MOE',   version: 'v2.1', timeCategory: '近3天', region: '大園區', trend: '穩定中', aqi: 35,  temperature: 22, humidity: 75 },
  ...
  { id: 11, district: '桃園都會區',   station: 'LUV-Hub M1',       time: '3天前 16:30', passed: true,  pollutant: 'PM₂.₅', value: 18, unit: 'μg/m³', source: 'LUV',   version: 'v3.0', timeCategory: '近7天', region: '桃園區', trend: '下降中', aqi: 62,  temperature: 26, humidity: 69 },
  { id: 12, district: '觀音沿海',     station: 'Station TY-35',    time: '4天前 14:20', passed: true,  pollutant: 'O₃',    value: 31, unit: 'ppb',    source: 'MOE',   version: 'v2.1', timeCategory: '近7天', region: '觀音區', trend: '穩定中', aqi: 38,  temperature: 23, humidity: 77 },
  ...
  { id: 15, district: '桃園高鐵站',   station: 'LUV-Station H4',   time: '7天前 15:30', passed: true,  pollutant: 'PM₂.₅', value: 15, unit: 'μg/m³', source: 'LUV',   version: 'v3.0', timeCategory: '近7天', region: '桃園區', trend: '下降中', aqi: 55,  temperature: 26, humidity: 67 },
];

const TIME_TABS = ['近24小時', '近3天', '近7天'] as const;
const POLLUTANTS = ['全部污染物', 'PM₂.₅', 'O₃', 'NOx', 'VOCs'];
