  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: `0 2px 12px ${cfg.color}22, 0 4px 20px rgba(54, 73, 58, 0.10)`,
    ...
    >
      ...
      {xDomain === null ? (
        ...
        <ResponsiveContainer width="100%" height="100%">
          ...
          >
            <CartesianGrid strokeDasharray="3 3" stroke="rgba(54, 73, 58, 0.15)" />
