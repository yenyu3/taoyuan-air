...
const getWeatherIcon = (w: string): React.ComponentProps<typeof Feather>['name'] => {
  ...
  const loadData = async () => {
    ...
    try {
      ...
      const [, grid, alertsData, eventsData] = await Promise.all([
        getMeta(), getGrid({ pollutant: 'PM25' }), getAlerts(), getEvents(),
      ]);
      setGridCells(grid);
      ...
      <ScrollView ref={scrollRef} style={styles.scrollView} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.card}>
            ...
            <View style={styles.cardHeaderRow}>
              <View style={styles.cardTitleGroup}>
                <Feather name="wind" size={15} color="#6abe74" />
              ...
              <View style={[styles.aqiBadge, {
                ...
                <Text style={[styles.aqiBadgeLabelText, { color: getAQIColor(locatedAqi) }]}>AQI</Text>
                <Text style={[styles.aqiBadgeValueText,  { color: getAQIColor(locatedAqi) }]}>{locatedAqi}</Text>
              </View>
            </View>
            ...
            <View style={styles.pm25Row}>
              <View>
                ...
                <View style={styles.pm25ValueRow}>
                  <Text style={[styles.pm25BigNum, { color: pm25Color }]}>{pm25}</Text>
                  <Text style={styles.pm25UnitText}>μg/m³</Text>
                  <View style={[styles.pm25StatusPill, { backgroundColor: `${pm25Color}18` }]}>
                  <Text style={[styles.pm25StatusLabel, { color: pm25Color }]}>
            ...
            <View style={styles.hProgressTrack}>
              <View style={[styles.hProgressFill, {
                width: `${pm25Progress}%`,
            ...
            <View style={styles.hProgressScale}>
              {['0', '12', '35', '55', '75+'].map((v, i) => (
                <Text key={i} style={styles.hScaleText}>{v}</Text>
              ))}
            </View>
            ...
            <View style={[styles.adviceRow, {
              ...
              <View style={[styles.adviceIconBg, { backgroundColor: `${activityInfo.iconColor}20` }]}>
                <Feather name={activityInfo.icon} size={18} color={activityInfo.iconColor} />
              </View>
            ...
            <View style={styles.miniPollutRow}>
              ...
              <View style={styles.miniPollutRight}>
                <Text style={[styles.miniPollutVal, { color: getO3Color(o3) }]}>{o3}</Text>
            ...
            <View style={[styles.miniPollutRow, { marginBottom: 0 }]}>
              ...
              <View style={styles.miniPollutRight}>
                <Text style={[styles.miniPollutVal, { color: getNO2Color(no2) }]}>{no2}</Text>
                <Text style={styles.miniPollutUnit}>ppb</Text>
              </View>
            </View>
        ...
        <View style={styles.sectionPad}>
          <View style={styles.card}>
            ...
            <View style={styles.cardHeaderRow}>
              <View style={styles.cardTitleGroup}>
                <Feather name={getWeatherIcon(currentWeather.weather)} size={15} color="#6abe74" />
                <Text style={styles.cardSectionTitle}>WEATHER</Text>
              </View>
              <View style={styles.districtBadge}>
                <Feather name="map-pin" size={10} color="#7FAE8A" />
            ...
            <View style={styles.weatherCurrentRow}>
              <View>
                <Text style={styles.weatherTempBig}>{currentWeather.temperature}°</Text>
              ...
              <View style={styles.weatherIconCircle}>
                <Feather name={getWeatherIcon(currentWeather.weather)} size={34} color="#6abe74" />
              </View>
            </View>
              ...
              {[
                ...
                <React.Fragment key={i}>
                  <View style={styles.weatherStatItem}>
                    <Feather name={item.icon as any} size={13} color="#6abe74" />
...
const styles = StyleSheet.create({
  ...
  highlightText: { color: '#6abe74', fontWeight: 'bold' },
  ...
  cardSectionTitle: {
    fontSize: 13, fontWeight: 'bold', color: '#666', letterSpacing: 1.2,
  },
  dividerLine: {
    height: 1,
  ...
  pm25BigNum: {
    fontSize: 52, fontWeight: 'bold', lineHeight: 54,
  },
  pm25UnitText: {
    fontSize: 12, fontWeight: '600', color: '#9ca3af', marginBottom: 4, marginRight: 6,
  },
  pm25StatusPill: {
  ...
  districtBadge: {
    ...
    borderRadius: 10,
    borderWidth: 1,
    borderColor: 'rgba(106,190,116,0.25)',
  },
  districtBadgeText: {
    fontSize: 12, fontWeight: '600', color: '#7FAE8A',
  },
  weatherCurrentRow: {
    flexDirection: 'row',
    justifyContent: 'space-between',
  ...
  weatherTempBig: {
    fontSize: 54, fontWeight: 'bold', color: '#222', lineHeight: 58,
  },
  weatherDesc: {
  ...
  weatherStatVal: {
    fontSize: 12, fontWeight: '700', color: '#333', marginTop: 2,
  },
  weatherStatLabel: {
    fontSize: 10, color: '#aaa',
  },
  weatherStatSep: {
    width: 1, height: 28, backgroundColor: 'rgba(0,0,0,0.07)',
  },
  ...
  forecastTempHigh: {
    fontSize: 13, fontWeight: '700', color: '#e05c2a',
  },
  forecastTempLow: {
    fontSize: 13, color: '#7FAE8A', fontWeight: '600',
  },
  forecastPopRow: {
